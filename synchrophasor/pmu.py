...
class Pmu(object):
    ...
    def __init__(self, pmu_id=7734, data_rate=30, port=4712, ip='127.0.0.1', method='SYNCHROPASOR', buffer_size=2048):
    ...
    def run(self):
        ...
        self.socket.sendto(self.cfg2.convert2bytes(),(self.ip,self.port))
...
#         self.send(self.header)
    ...
    def send(self, frame, set_timestamp=True):
        ...
        self.socket.sendto(data,(UDP_IP, UDP_PORT))
...
#             buffer.put(data)
    ...
    def send_data(self, phasors=[], analog=[], digital=[], freq=0, dfreq=0,
        ...
        self.socket.sendto(data_frame,(UDP_IP, UDP_PORT))
#             
#         for buffer in self.client_buffers:
